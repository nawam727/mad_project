  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(
          child:ListView(
          children: [
            //lecturers' Cabin state text
            Padding(
              padding:EdgeInsets.only(top:size.width*0.06,bottom:size.width*0.06,left:size.width*0.06),
              child: Text(
                "Lecturers' Cabin State",
                style:TextStyle(
             ...
             Padding(
               padding:EdgeInsets.only(left:size.width*0.06,top:size.width*0.025,right:size.width*0.06,),
               child: Container(
