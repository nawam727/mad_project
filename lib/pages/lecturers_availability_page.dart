...
class LecturerAvailabilityPage extends StatelessWidget {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          lecturerCard(
                              ...
                              "A",
                              context,
                              "Mr. Dilhara Batan Arachchige is attached to the Department of Network & Security of Faculty of Computing of NSBM Green University. He completed his Bachelor of Science degree with a First Class Honours from University of Kelaniya and reading for his masters in the field of Cybersecurity. He selected for the Dean’s Award list (Academic year 2016/2017) of University of Kelaniya for his academic excellence. After graduation, he joined NSBM Green University as an instructor and thereafter worked as a Teaching Assistant. Currently, he is working as a Lecturer attached to the Faculty of Computing. His research interests lie in the fields of digital forensics and machine learning applications in cybersecurity domain.",
                              letter),
                        ],
                      ),
                      Column(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          lecturerCard(
                              size,
                              "assets/images/gayan.png",
                              "Mr.Gayan \n Perera",
                              "P",
                              context,
                              "Mr. Gayan Rukshantha is a graduate of NSBM Green University with a first-class (Hons) degree in Bachelor of Science in Management Information Systems (special). Currently, he is reading for his Master’s in Business Analytics and Data Science at the University of Colombo, School of Computing.\nBefore joining academia, he was an Industrial Engineer at MAS Slimline Pannala, after his graduation, he joined NSBM Green University as a Teaching Assistant and currently working as a Lecturer attached to the Faculty of Computing. He delivers modules such as Operating Systems, Data Structures and Algorithms, Fundamentals of Mathematics, Computational Thinking, and Computer Architecture. His research interests are in the fields of Data Programming, Machine Learning, and Applied Statistics",
                              letter),
                          lecturerCard(
                              size,
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        top: size.width * 0.01, bottom: size.width * 0.002),
                    child: Text(
                      name,
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    //attendance
                    child: circle(attendanceLetter, size),
                  ),
                ),
                SizedBox(
  ...
  Row circle(String atLetter, Size size) {
    if (atLetter == "P" || atLetter == "p") {
      return Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Expanded(
            flex: 1,
            child: oneCircle("P", "#00B251", size),
          ),
          SizedBox(
          ...
          Expanded(
            flex: 1,
            child: oneCircle("A", "#D9DBDD", size),
          ),
        ],
      );
    } else if (atLetter == "L" || atLetter == "l") {
      return Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Expanded(
            flex: 1,
            child: oneCircle("P", "#D9DBDD", size),
          ),
          SizedBox(
            width: size.width * 0.008,
          ),
  ...
  Center oneCircle(String letter, String color1, Size size) {
    return Center(
      child: Container(
        decoration:
            BoxDecoration(shape: BoxShape.circle, color: HexColor("#$color1")),
        child: Padding(
