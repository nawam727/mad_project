...
class FeedbackPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: DrawerScreen(),
      appBar: BackNotify(title:'Feedback & Suggestions'),
      body: ListView(
        children: <Widget>[
      Padding(
      ...
      child: Column(
       ...
       Center(
           ...
           initialRating: 3.5, // You can set an initial rating if needed
           minRating: 0,
          ...
          SizedBox(height: 0),
          Padding(
            padding: EdgeInsets.only(top: 10, bottom: 10, left: 30), // Add padding to move text down
            child: Text(
  ...
  children: [
    ...
    Padding(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: HexColor("FFFFFF"), // You can set the desired color
          elevation: 3,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(8.0),
          side: BorderSide(
          color: HexColor("C4C5C2"), // Change the border color here
          ),
          ),
          fixedSize: Size(120, 45),
        ),
