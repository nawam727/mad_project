...
class SupportPage extends StatelessWidget {
          ...
          Container(
            ...
            children: [
              Column(
                children: [
                  cards(
                      "assets/images/information.png", 'Get Started', 15, size),
                  cards("assets/images/conversation.png", "Help Center", 15,
                      size),
                ],
              ),
              Column(
                children: [
                  cards("assets/images/call.png", 'Chat with Us', 15, size),
                  cards("assets/images/chat.png", "Feedback and Suggestions",
                      13, size),
                ],
              )
            ],
  ...
  Container cards(String imageLink, String title1, double fontsize, Size size) {
    return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ClipRRect(
              ...
              child: Padding(
                padding:  EdgeInsets.only(top:size.width*0.03), // Add padding to move the text down
                child: Image.asset(
                  imageLink,
